# kb-redesign：两角色设计稿（v0.1，2026-08-08）

> 定位：在 DITA 中从零重塑知识体系的设计正本。经验输入是 [../vault-inventory/](../vault-inventory/README.md)（422 篇实测），方法依据是 dita2 笔记（引用处标注篇号）。旧 Obsidian 库为只读矿场，内容不迁移——重写只带走主题与判据，不带走旧文本。
>
...
裁定记录见 [review-checklist-v0.1.md](review-checklist-v0.1.md)。
