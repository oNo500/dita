> **已被取代（2026-08-15 归档）**：本文列的 4 项治理缺口中，缺口 1/2 由 `dita-tools`
> 的词表直读与值校验解决，缺口 3/4 由 `dita-tools ia` 解决；治理主体的划分见
> [docs/architecture.md](../../../docs/architecture.md) §四。本文按原样保留作推导记录。
