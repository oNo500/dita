...
> **已迁移（2026-08-16）**：正本已迁 kb（`kb/topics/dita/principles/roles-and-boundaries.dita` ← §1、§2、§4，并入 §3「各角色该读什么」作为结论节的阅读边界论述；`kb/topics/dita/principles/schema-authority.dita` ← §5–8；不迁小节：无），本文冻结为调研档案，不再更新。
